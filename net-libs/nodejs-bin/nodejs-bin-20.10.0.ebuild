...
SRC_URI="
elibc_glibc? ( https://nodejs.org/dist/v20.10.0/node-v20.10.0-linux-x64.tar.xz -> ${P}.tar.xz )
elibc_musl? ( https://unofficial-builds.nodejs.org/download/release/v20.10.0/node-v20.10.0-linux-x64-musl.tar.xz -> ${P}.tar.xz )
"
KEYWORDS="amd64"
SLOT="0"
